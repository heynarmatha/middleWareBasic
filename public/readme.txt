...
-
urlencoded()
: to parse the body of requests with URL-encoded payload
-
static()
...
(development, production, etc) using 
...
The 
config 
package gives us an elegant way to store configuration settings for 
our applications. 
-
We can use the 
debug 
package to add debugging information to an application. 
