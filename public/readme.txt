A middleware function is a function that takes a request object and either terminates the
...
- We can detect the environment in which our Node application is running (development,
